  ...
  try {
    ...
    const mockData = {
      administrative_reviews: [
        ["社会保障制度改革推進事業", "厚生労働省", "1200000000", "95.2", "令和4年度", "受給者数"],
        ["道路インフラ整備事業", "国土交通省", "800000000", "88.7", "令和4年度", "整備延長"],
        ["教育振興支援事業", "文部科学省", "600000000", "92.1", "令和4年度", "参加者数"],
        ["地域活性化推進事業", "内閣府", "450000000", "89.3", "令和4年度", "雇用創出数"],
        ["環境保全対策事業", "環境省", "320000000", "91.8", "令和4年度", "CO2削減量"],
        ["デジタル化推進事業", "総務省", "280000000", "87.5", "令和4年度", "システム導入数"],
        ["農業振興事業", "農林水産省", "250000000", "93.4", "令和4年度", "生産量増加"],
        ["中小企業支援事業", "経済産業省", "220000000", "90.1", "令和4年度", "支援企業数"],
      ],
    }

    const columns = ["事業名", "省庁名", "予算額", "執行率", "年度", "効果測定指標"]
    ...
    if (query.toLowerCase().includes("order by 予算額 desc")) {
      resultRows = [...resultRows].sort((a, b) => Number.parseInt(b[2]) - Number.parseInt(a[2]))
    }
